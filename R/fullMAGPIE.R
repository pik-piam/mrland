...
fullMAGPIE <- function(rev = numeric_version("0.1"), dev = "") {
  ...
  calcOutput("TauTotal",  years = 1995, round = 2, outputStatistics = stats, file = "fm_tau1995.cs4", aggregate = superregion)
  ...
  calcOutput("GovernanceIndicator", years = shortYears, round = 4, outputStatistics = stats, file = "f09_governance_indicator.cs3")
  ...
  # 13 tc
  calcOutput("ExoTcDummy",       round = 4, outputStatistics = stats, file = "f13_tau_scenario.csv", aggregate = superregion)
  calcOutput("TCguess",          round = 3, outputStatistics = stats, file = "f13_tcguess.cs4", aggregate = superregion)
  calcOutput("TauHistorical",    round = 2, outputStatistics = stats, file = "f13_tau_historical.csv", aggregate = superregion)

  # 14 yields
  calcOutput("PastureYield", round = 3, outputStatistics = stats, file = "f14_pasture_yields_hist.csv")
  calcOutput("FAOYield", cut = 0.98, years = magYearsPast, round = 2, outputStatistics = stats, file = "f14_region_yields.cs3")
  ...
  calcOutput("RegressionParameters", aggregate = FALSE, round = 3, outputStatistics = stats, file = "f15_schofield_parameters.cs3",
             regression = "Schofield")
  calcOutput("RegressionParameters", aggregate = FALSE, round = 3, outputStatistics = stats, file = "f15_schofield_parameters_height.cs3",
             regression = "FAO_WHO_UNU1985")
  calcOutput("RegressionParameters", aggregate = FALSE, round = 3, outputStatistics = stats, file = "f15_bmi_shr_regr_paras.cs3",
             regression = "bmi_shr")
  calcOutput("RegressionParameters", aggregate = FALSE, round = 3, outputStatistics = stats, file = "f15_demand_regression_parameters.cs3",
             regression = "demand_regression")
  calcOutput("RegressionParameters", aggregate = FALSE, round = 3, outputStatistics = stats, file = "f15_bodyheight_regr_paras.cs3",
             regression = "bodyheight_regression")

  calcOutput("Intake", modelinput = "age_groups_hist", standardize = FALSE, method = "FAO_WHO_UNU1985",
             aggregate = FALSE, years = magYearsPast, round = 1, outputStatistics = stats, file = "f15_intake_pc_observed_iso.cs3")
  ...
  calcOutput("Household_balanceflow",    years = magYears, round = 4, outputStatistics = stats, file = "f15_household_balanceflow.cs3")
  calcOutput("NutritionAttributes",      years = magYears, round = 4, outputStatistics = stats, file = "f15_nutrition_attributes.cs3",
             aggregate = FALSE)
  calcOutput("IniFoodPrice", datasource = "FAO", years = NULL, round = 4,
             products = "kall", outputStatistics = stats, file = "f15_prices_initial.csv", aggregate = FALSE, year = "y2005")
  calcOutput("BMIshr", convert = TRUE, years = magYearsPast, round = 4, outputStatistics = stats, file = "f15_bmi_shr_past.cs3",
             aggregate = FALSE)
  calcOutput("BMI", outputStatistics = stats, file = "f15_bmi.cs3", aggregate = FALSE)

  calcOutput("EATLancetDiets",  aggregate = TRUE, round = 4, outputStatistics = stats, file = "f15_intake_EATLancet.cs3",
             attributes = "kcal", calib = TRUE, FAOcountr = FALSE)
  calcOutput("EATLancetDiets",  aggregate = FALSE, round = 1, outputStatistics = stats, file = "f15_intake_EATLancet_iso.cs3",
             attributes = "kcal", calib = TRUE, FAOcountr = FALSE)
  calcOutput("EATLancetWaste",  aggregate = TRUE, round = 4, outputStatistics = stats, file = "f15_supply2intake_ratio_bottomup.cs3",
             out_type = "ratio_detailed")
  calcOutput("EATLancetWaste",  aggregate = FALSE, round = 4, outputStatistics = stats, file = "f15_supply2intake_ratio_bottomup_iso.cs3",
             out_type = "ratio_detailed")
  calcOutput("EATLancetWaste",  aggregate = TRUE, round = 4, outputStatistics = stats, file = "f15_calib_factor_FAOfsupply.cs4",
             out_type = "calib")
  calcOutput("EATLancetWaste",  aggregate = FALSE, round = 4, outputStatistics = stats, file = "f15_calib_factor_FAOfsupply_iso.cs4",
             out_type = "calib")
  calcOutput("FAOLossesWaste",  aggregate = TRUE, round = 4, outputStatistics = stats, file = "f15_supply2intake_ratio_FAO.cs3",
             out_type = "waste")
  calcOutput("FAOLossesWaste",  aggregate = FALSE, round = 4, outputStatistics = stats, file = "f15_supply2intake_ratio_FAO_iso.cs3",
             out_type = "waste")
  calcOutput("EATLancetTargets", aggregate = TRUE, round = 4, outputStatistics = stats, file = "f15_targets_EATLancet.cs3",
             attributes = "kcal/d")
  calcOutput("EATLancetTargets", aggregate = FALSE, round = 4, outputStatistics = stats, file = "f15_targets_EATLancet_iso.cs3",
             attributes = "kcal/d")
  calcOutput("EATFruitvegRatio", aggregate = TRUE, round = 4, outputStatistics = stats, file = "f15_fruitveg2others_kcal_ratio.cs3",
             populationweight = "PopulationPast")
  calcOutput("EATFruitvegRatio", aggregate = FALSE, round = 4, outputStatistics = stats, file = "f15_fruitveg2others_kcal_ratio_iso.cs3",
             populationweight = "PopulationPast")
  ...
  # 16 demand
  calcOutput("Attributes", round = 4, aggregate = FALSE,        outputStatistics = stats, file = "fm_attributes.cs3")
  calcOutput("SeedShare", years = magYears, round = 4,           outputStatistics = stats, file = "f16_seed_shr.csv")
  calcOutput("LossShare", years = magYears, round = 4,           outputStatistics = stats, file = "f16_waste_shr.csv")
  calcOutput("DomesticBalanceflow", years = magYears, round = 4, outputStatistics = stats, file = "f16_domestic_balanceflow.csv")
  ...
  calcOutput("TradeSelfSuff",    years = magYears, round = 6, outputStatistics = stats, file = "f21_trade_self_suff.cs3",
             aggregate = superregion)
  calcOutput("TradeExportShr",   years = magYears, round = 6, outputStatistics = stats, file = "f21_trade_export_share.cs3",
             aggregate = superregion)
  calcOutput("TradeBalanceflow", years = magYears, round = 6, outputStatistics = stats, file = "f21_trade_balanceflow.cs3",
             aggregate = FALSE)
  calcOutput("TradeBalance", years = magYears, round = 6, outputStatistics = stats, file = "f21_trade_balance.cs3",
             aggregate = superregion)
  calcOutput("TradeMargin", round = 6, outputStatistics = stats, file = "f21_trade_margin.cs3",
             aggregate = superregion)
  calcOutput("TradeTariff", round = 6, outputStatistics = stats, file = "f21_trade_tariff.cs3",
             aggregate = superregion)
  ...
  if (grepl("+grasslandRealization", dev)) {
    calcOutput("PastureYield", range_pastr = TRUE, round = 3, outputStatistics = stats, file = "f31_grassl_yld_hist.cs3")
  }

  # 32 forestry
  calcOutput("AfforestCosts", years = 2001,        round = 0, outputStatistics = stats, file = "f32_fac_req_ha.csv")
  calcOutput("GrowingStockPlantations", aggregate = TRUE, round = 0, outputStatistics = stats, file = "f32_gs_target.cs4")
  calcOutput("GrowingStockPlantAbsolute", aggregate = TRUE, round = 0, outputStatistics = stats, file = "f32_gs_absolutetarget.cs4")
  calcOutput("GrowingStockpha", aggregate = TRUE, round = 0, outputStatistics = stats, file = "f32_gs_relativetarget.cs4")
  calcOutput("PlantationContribution", aggregate = TRUE, round = 3, outputStatistics = stats, file = "f32_plantation_contribution.cs3")
  ...
  calcOutput("TradeSelfSuff",    years = magYears, round = 2, outputStatistics = stats, file = "f32_trade_self_suff.cs3",
             aggregate = superregion)
  ...
  calcOutput("GrowingStockNatVegAbsolute", aggregate = TRUE, round = 0, outputStatistics = stats, file = "f35_gs_absolutetarget.cs4")
  calcOutput("GrowingStockNRF", aggregate = TRUE, round = 0, outputStatistics = stats, file = "f35_gs_relativetarget.cs4")
  ...
  calcOutput("FacReq", round = 2, aggregate = "GLO", years = 2005, outputStatistics = stats, file = "f38_fac_req_fao.csv")
  ...
  # 50 n soil budget
  calcOutput("SNUpE", years = magYears, round = 4, outputStatistics = stats, file = "f50_snupe.cs4", rev = rev, maccbase = FALSE)
  calcOutput("SNUpE", years = magYears, round = 4, outputStatistics = stats, file = "f50_snupe_base.cs4", rev = rev, maccbase = TRUE)
  calcOutput("NitrogenBudgetBalanceflow", years = magYears, round = 4, outputStatistics = stats, file = "f50_nitrogen_balanceflow.cs4")
  calcOutput("NitrogenFixationNdfa", years = magYears, round = 4, outputStatistics = stats, file = "f50_ndfa.cs4")
  calcOutput("NitrogenFixationFreeliving", round = 4, outputStatistics = stats, file = "f50_fixation_freeliving.cs4", aggregate = FALSE)
  calcOutput("AtmosphericDepositionRates", round = 4, outputStatistics = stats, file = "f50_atmospheric_deposition_rates.cs4")

  calcOutput("NuePasture", years = magYears, round = 4, outputStatistics = stats, file = "f50_nue_pasture.cs4", maccbase = FALSE)
  calcOutput("NuePasture", years = magYears, round = 4, outputStatistics = stats, file = "f50_nue_base_pasture.cs4", maccbase = TRUE)
  ...
  calcOutput("EfNSoil",  round = 4, outputStatistics = stats, file = "f51_ef_n_soil.cs3", aggregate = FALSE, method = "IPCC")
  ...
  # 52 carbon
  calcOutput("AdjustGrassi2021", aggregate = TRUE, outputStatistics = stats, file = "f52_land_carbon_sink_adjust_grassi.cs3")
  ...
  # 55 awms
  calcOutput("ManureFuelShr",      years = magYears,  round = 4, outputStatistics = stats, file = "f55_manure_fuel_shr.cs4")
  calcOutput("AWMSconfShr",        years = magYears,  round = 4, outputStatistics = stats, file = "f55_awms_shr.cs4", rev = rev)
  calcOutput("EF3confinement", selection = "recycling", round = 4, outputStatistics = stats, file = "f55_awms_recycling_share.cs4")
  ...
  # 62 Material
  calcOutput("DemMaterial", years = magYearsPast, round = 4, outputStatistics = stats, file = "f62_dem_material.cs3")
  calcOutput("BioplasticToBiomass", aggregate = FALSE, round = 4, outputStatistics = stats, file = "f62_bioplastic2biomass.csv")
  ...
  # 70 livestock
  calcOutput("FeedBaskets",           years = magYears,  round = 4, outputStatistics = stats, file = "f70_feed_baskets.cs3")
  calcOutput("FeedBalanceflow",       years = magYears,  round = 4, outputStatistics = stats, file = "f70_feed_balanceflow.cs3")
  calcOutput("LivestockProductivity", years = magYears,  round = 4, outputStatistics = stats, file = "f70_livestock_productivity.cs3")
  calcOutput("SlaughterFeedShare",    years = magYears,  round = 4, outputStatistics = stats, file = "f70_slaughter_feed_share.cs4")
  calcOutput("PYieldSlope",                             round = 2, outputStatistics = stats, file = "f70_pyld_slope_reg.cs4")
