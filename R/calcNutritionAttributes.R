calcNutritionAttributes <- function() {
  ...
  fooduseMilling <- dimSums(massbalance[, , c("food", "milling")][, , c("dm")], dim = c(1, 3.2, 3.3), na.rm = TRUE)
  ...
  return(list(x = out, weight = NULL,
              ...
              description = paste("Values from FAO Food Supply.",
                                  "Describe final calory and protein supply of a product dedicated for fooduse.")))
}
